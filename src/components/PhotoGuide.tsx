...
const PhotoGuide = () => {
  return (
    <div className="flex w-full justify-center">
      <div className="rounded-xl bg-green-50 border-2 border-green-200 md:flex overflow-hidden w-fit">
        <div className="p-3 border-b border-green-200 border-r-2 flex">
